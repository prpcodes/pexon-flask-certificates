            ...
            <div title="Change Theme" className="dropdown dropdown-end ">
                ...
                <div className="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96 h-[70vh] w-52 overflow-y-auto shadow-2xl mt-16 scrollbar-hide">
                    <div className="grid grid-cols-1 gap-3 p-3" tabIndex={0}>
                        <div data-act-class="outline" className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2 hover:outline" data-set-theme="dark">
                        ...
                        {themes.map((theme) => (
                            <div data-act-class="outline" className={'outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2 hover:outline'} data-set-theme={theme} key={theme}>
